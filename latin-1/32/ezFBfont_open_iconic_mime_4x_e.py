'''
    ezFBfont_open_iconic_mime_4x_e : generated as part of the microPyEZfonts repository
...
# Cmd: ['bdf2dict.py', 'bdf-sources/open_iconic_mime_4x.bdf', '../latin-1/e-char.set']
