'''
    ezFBfont_open_iconic_other_4x_u : generated as part of the microPyEZfonts repository
...
# Font: open_iconic_other_4x Char set: b' !"#$%&\'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_'
# Cmd: ['bdf2dict.py', 'bdf-sources/open_iconic_other_4x.bdf', '../latin-1/u-char.set']
