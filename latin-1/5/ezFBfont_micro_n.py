'''
    ezFBfont_micro_n : generated as part of the microPyEZfonts repository
...
# Font: micro Char set: b' %()*+,-./0123456789:\xb0'
# Cmd: ['bdf2dict.py', 'bdf-sources/micro.bdf', '../latin-1/n-char.set']
