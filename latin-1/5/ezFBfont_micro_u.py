'''
    ezFBfont_micro_u : generated as part of the microPyEZfonts repository
...
# Font: micro Char set: b' !"#$%&\'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_'
# Cmd: ['bdf2dict.py', 'bdf-sources/micro.bdf', '../latin-1/u-char.set']
