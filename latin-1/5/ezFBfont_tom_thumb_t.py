'''
    ezFBfont_tom_thumb_t : generated as part of the microPyEZfonts repository
...
# Font: tom-thumb Char set: b' +-.0123456789:'
# Cmd: ['bdf2dict.py', 'bdf-sources/tom-thumb.bdf', '../latin-1/t-char.set']
