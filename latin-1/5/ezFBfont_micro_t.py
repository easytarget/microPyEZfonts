'''
    ezFBfont_micro_t : generated as part of the microPyEZfonts repository
...
# Font: micro Char set: b' +-.0123456789:'
# Cmd: ['bdf2dict.py', 'bdf-sources/micro.bdf', '../latin-1/t-char.set']
