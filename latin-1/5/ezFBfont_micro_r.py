'''
    ezFBfont_micro_r : generated as part of the microPyEZfonts repository
...
# Font: micro Char set: b' !"#$%&\'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~'
# Cmd: ['bdf2dict.py', 'bdf-sources/micro.bdf', '../latin-1/r-char.set']
