'''
    ezFBfont_spleen_5x8_n : generated as part of the microPyEZfonts repository
...
# Font: spleen-5x8 Char set: b' %()*+,-./0123456789:\xb0'
# Cmd: ['bdf2dict.py', 'bdf-sources/spleen-5x8.bdf', '../latin-1/n-char.set']
