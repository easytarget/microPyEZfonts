'''
    ezFBfont_spleen_5x8_u : generated as part of the microPyEZfonts repository
...
# Font: spleen-5x8 Char set: b' !"#$%&\'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_'
# Cmd: ['bdf2dict.py', 'bdf-sources/spleen-5x8.bdf', '../latin-1/u-char.set']
