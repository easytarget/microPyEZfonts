'''
    ezFBfont_6x10_u : generated as part of the microPyEZfonts repository
...
# Font: 6x10 Char set: b' !"#$%&\'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_'
# Cmd: ['bdf2dict.py', 'bdf-sources/6x10.bdf', '../latin-1/u-char.set']
