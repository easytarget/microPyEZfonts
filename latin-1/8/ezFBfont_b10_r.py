'''
    ezFBfont_b10_r : generated as part of the microPyEZfonts repository
...
# Font: b10 Char set: b' !"#$%&\'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~'
# Cmd: ['bdf2dict.py', 'bdf-sources/b10.bdf', '../latin-1/r-char.set']
