'''
    ezFBfont_m2icon_7_r : generated as part of the microPyEZfonts repository
...
# Font: m2icon_7 Char set: b' !"#$%&\'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~'
# Cmd: ['bdf2dict.py', 'bdf-sources/m2icon_7.bdf', '../latin-1/r-char.set']
