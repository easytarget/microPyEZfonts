'''
    ezFBfont_spleen_16x32_n : generated as part of the microPyEZfonts repository
...
# Font: spleen-16x32 Char set: b' %()*+,-./0123456789:\xb0'
# Cmd: ['bdf2dict.py', 'bdf-sources/spleen-16x32.bdf', '../latin-1/n-char.set']
