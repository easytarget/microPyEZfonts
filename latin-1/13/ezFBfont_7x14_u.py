'''
    ezFBfont_7x14_u : generated as part of the microPyEZfonts repository
...
# Font: 7x14 Char set: b' !"#$%&\'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_'
# Cmd: ['bdf2dict.py', 'bdf-sources/7x14.bdf', '../latin-1/u-char.set']
