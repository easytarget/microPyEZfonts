'''
    ezFBfont_courB08_n : generated as part of the microPyEZfonts repository
...
# Font: courB08 Char set: b' %()*+,-./0123456789:\xb0'
# Cmd: ['bdf2dict.py', 'bdf-sources/courB08.bdf', '../latin-1/n-char.set']
