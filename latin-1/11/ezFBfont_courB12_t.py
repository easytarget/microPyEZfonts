'''
    ezFBfont_courB12_t : generated as part of the microPyEZfonts repository
...
# Font: courB12 Char set: b' +-.0123456789:'
# Cmd: ['bdf2dict.py', 'bdf-sources/courB12.bdf', '../latin-1/t-char.set']
