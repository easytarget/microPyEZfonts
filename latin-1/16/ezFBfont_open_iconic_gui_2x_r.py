'''
    ezFBfont_open_iconic_gui_2x_r : generated as part of the microPyEZfonts repository
...
# Font: open_iconic_gui_2x Char set: b' !"#$%&\'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~'
# Cmd: ['bdf2dict.py', 'bdf-sources/open_iconic_gui_2x.bdf', '../latin-1/r-char.set']
