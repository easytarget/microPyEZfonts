'''
    ezFBfont_courR14_t : generated as part of the microPyEZfonts repository
...
# Font: courR14 Char set: b' +-.0123456789:'
# Cmd: ['bdf2dict.py', 'bdf-sources/courR14.bdf', '../latin-1/t-char.set']
