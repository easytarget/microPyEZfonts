'''
    ezFBfont_6x13O_r : generated as part of the microPyEZfonts repository
...
# Font: 6x13O Char set: b' !"#$%&\'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~'
# Cmd: ['bdf2dict.py', 'bdf-sources/6x13O.bdf', '../latin-1/r-char.set']
