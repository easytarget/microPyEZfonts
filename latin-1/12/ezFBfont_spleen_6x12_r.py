'''
    ezFBfont_spleen_6x12_r : generated as part of the microPyEZfonts repository
...
# Font: spleen-6x12 Char set: b' !"#$%&\'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~'
# Cmd: ['bdf2dict.py', 'bdf-sources/spleen-6x12.bdf', '../latin-1/r-char.set']
