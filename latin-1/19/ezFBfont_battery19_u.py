'''
    ezFBfont_battery19_u : generated as part of the microPyEZfonts repository
...
# Font: battery19 Char set: b' !"#$%&\'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_'
# Cmd: ['bdf2dict.py', 'bdf-sources/battery19.bdf', '../latin-1/u-char.set']
