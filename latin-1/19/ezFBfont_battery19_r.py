'''
    ezFBfont_battery19_r : generated as part of the microPyEZfonts repository
...
# Font: battery19 Char set: b' !"#$%&\'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~'
# Cmd: ['bdf2dict.py', 'bdf-sources/battery19.bdf', '../latin-1/r-char.set']
