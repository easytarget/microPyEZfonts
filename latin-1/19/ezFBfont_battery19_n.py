'''
    ezFBfont_battery19_n : generated as part of the microPyEZfonts repository
...
# Font: battery19 Char set: b' %()*+,-./0123456789:\xb0'
# Cmd: ['bdf2dict.py', 'bdf-sources/battery19.bdf', '../latin-1/n-char.set']
