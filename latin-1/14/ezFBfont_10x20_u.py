'''
    ezFBfont_10x20_u : generated as part of the microPyEZfonts repository
...
# Font: 10x20 Char set: b' !"#$%&\'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_'
# Cmd: ['bdf2dict.py', 'bdf-sources/10x20.bdf', '../latin-1/u-char.set']
