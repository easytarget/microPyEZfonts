'''
    ezFBfont_etl16_thai_u : generated as part of the microPyEZfonts repository
...
# Font: etl16-thai Char set: b' !"#$%&\'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_'
# Cmd: ['bdf2dict.py', 'bdf-sources/etl16-thai.bdf', '../latin-1/u-char.set']
