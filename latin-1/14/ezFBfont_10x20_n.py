'''
    ezFBfont_10x20_n : generated as part of the microPyEZfonts repository
...
# Font: 10x20 Char set: b' %()*+,-./0123456789:\xb0'
# Cmd: ['bdf2dict.py', 'bdf-sources/10x20.bdf', '../latin-1/n-char.set']
