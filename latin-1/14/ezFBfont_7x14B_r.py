'''
    ezFBfont_7x14B_r : generated as part of the microPyEZfonts repository
...
# Font: 7x14B Char set: b' !"#$%&\'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~'
# Cmd: ['bdf2dict.py', 'bdf-sources/7x14B.bdf', '../latin-1/r-char.set']
