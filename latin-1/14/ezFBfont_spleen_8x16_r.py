'''
    ezFBfont_spleen_8x16_r : generated as part of the microPyEZfonts repository
...
# Font: spleen-8x16 Char set: b' !"#$%&\'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~'
# Cmd: ['bdf2dict.py', 'bdf-sources/spleen-8x16.bdf', '../latin-1/r-char.set']
