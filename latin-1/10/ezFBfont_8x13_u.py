'''
    ezFBfont_8x13_u : generated as part of the microPyEZfonts repository
...
# Font: 8x13 Char set: b' !"#$%&\'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_'
# Cmd: ['bdf2dict.py', 'bdf-sources/8x13.bdf', '../latin-1/u-char.set']
