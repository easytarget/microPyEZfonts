'''
    ezFBfont_7x13B_t : generated as part of the microPyEZfonts repository
...
# Font: 7x13B Char set: b' +-.0123456789:'
# Cmd: ['bdf2dict.py', 'bdf-sources/7x13B.bdf', '../latin-1/t-char.set']
