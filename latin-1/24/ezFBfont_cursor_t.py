'''
    ezFBfont_cursor_t : generated as part of the microPyEZfonts repository
...
# Font: cursor Char set: b' +-.0123456789:'
# Cmd: ['bdf2dict.py', 'bdf-sources/cursor.bdf', '../latin-1/t-char.set']
