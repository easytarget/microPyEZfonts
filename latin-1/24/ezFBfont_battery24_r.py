'''
    ezFBfont_battery24_r : generated as part of the microPyEZfonts repository
...
# Font: battery24 Char set: b' !"#$%&\'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~'
# Cmd: ['bdf2dict.py', 'bdf-sources/battery24.bdf', '../latin-1/r-char.set']
