'''
    ezFBfont_battery24_n : generated as part of the microPyEZfonts repository
...
# Font: battery24 Char set: b' %()*+,-./0123456789:\xb0'
# Cmd: ['bdf2dict.py', 'bdf-sources/battery24.bdf', '../latin-1/n-char.set']
