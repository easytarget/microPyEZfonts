'''
    ezFBfont_4x6_u : generated as part of the microPyEZfonts repository
...
# Font: 4x6 Char set: b' !"#$%&\'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_'
# Cmd: ['bdf2dict.py', 'bdf-sources/4x6.bdf', '../latin-1/u-char.set']
