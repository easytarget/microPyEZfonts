'''
    ezFBfont_m2icon_5_r : generated as part of the microPyEZfonts repository
...
# Font: m2icon_5 Char set: b' !"#$%&\'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~'
# Cmd: ['bdf2dict.py', 'bdf-sources/m2icon_5.bdf', '../latin-1/r-char.set']
