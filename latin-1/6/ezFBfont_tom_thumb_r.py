'''
    ezFBfont_tom_thumb_r : generated as part of the microPyEZfonts repository
...
# Font: tom-thumb Char set: b' !"#$%&\'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~'
# Cmd: ['bdf2dict.py', 'bdf-sources/tom-thumb.bdf', '../latin-1/r-char.set']
