'''
    ezFBfont_u8g2_percent_circle_25_r : generated as part of the microPyEZfonts repository
...
# Font: u8g2_percent_circle_25 Char set: b' !"#$%&\'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~'
# Cmd: ['bdf2dict.py', 'bdf-sources/u8g2_percent_circle_25.bdf', '../latin-1/r-char.set']
