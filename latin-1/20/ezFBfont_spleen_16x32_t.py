'''
    ezFBfont_spleen_16x32_t : generated as part of the microPyEZfonts repository
...
# Font: spleen-16x32 Char set: b' +-.0123456789:'
# Cmd: ['bdf2dict.py', 'bdf-sources/spleen-16x32.bdf', '../latin-1/t-char.set']
