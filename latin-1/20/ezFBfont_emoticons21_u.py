'''
    ezFBfont_emoticons21_u : generated as part of the microPyEZfonts repository
...
# Font: emoticons21 Char set: b' !"#$%&\'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_'
# Cmd: ['bdf2dict.py', 'bdf-sources/emoticons21.bdf', '../latin-1/u-char.set']
