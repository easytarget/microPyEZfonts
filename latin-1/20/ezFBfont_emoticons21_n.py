'''
    ezFBfont_emoticons21_n : generated as part of the microPyEZfonts repository
...
# Font: emoticons21 Char set: b' %()*+,-./0123456789:\xb0'
# Cmd: ['bdf2dict.py', 'bdf-sources/emoticons21.bdf', '../latin-1/n-char.set']
