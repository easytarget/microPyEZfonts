'''
    ezFBfont_5x7_u : generated as part of the microPyEZfonts repository
...
# Font: 5x7 Char set: b' !"#$%&\'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_'
# Cmd: ['bdf2dict.py', 'bdf-sources/5x7.bdf', '../latin-1/u-char.set']
