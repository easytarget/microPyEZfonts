...
charsets = {
        '0x0_0x39':'base (0x00 - 0x3F)',
        '0x40_0x79':'lower (0x40 - 0x7F)',
        '0x80_0xBF':'mid (0x80 - 0xBF)',
        '0xC0_0xFF':'upper (0xC0 - 0xFF)',
        '0x100_0x1FF':'extended (0x100 - 0x1FF)',
        '0x0_0xFFF':'full (0x00 - 0xFFF)',
        }
csets = charsets.keys()
foundsets = []
