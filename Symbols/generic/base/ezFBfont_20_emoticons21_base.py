'''
    ezFBfont_20_emoticons21_base : generated as part of the microPyEZfonts repository
...
# Font: emoticons21
# Cmd: [bdf2dict.py], ['Symbols-bdf-sources/emoticons21.bdf', './base-char.set', 'True']
...
def get_ch(ch):
    ...
    if c not in _g.keys():
        return None, 0, 0
    return memoryview(_g[c][0]), 20, 22
