'''
    ezFBfont_16_open_iconic_other_2x_lower : generated as part of the microPyEZfonts repository
...
# Cmd: [bdf2dict.py], ['Symbols-bdf-sources/open_iconic_other_2x.bdf', './lower-char.set', 'True']
