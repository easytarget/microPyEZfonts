'''
    ezFBfont_08_open_iconic_embedded_1x_lower : generated as part of the microPyEZfonts repository
...
# Cmd: [bdf2dict.py], ['Symbols-bdf-sources/open_iconic_embedded_1x.bdf', './lower-char.set', 'True']
