'''
    ezFBfont_08_open_iconic_all_1x_lower : generated as part of the microPyEZfonts repository
...
# Cmd: [bdf2dict.py], ['Symbols-bdf-sources/open_iconic_all_1x.bdf', '_', './lower-char.set']
