'''
    ezFBfont_16_open_iconic_all_2x_upper : generated as part of the microPyEZfonts repository
...
# Cmd: [bdf2dict.py], ['Symbols-bdf-sources/open_iconic_all_2x.bdf', './upper-char.set', 'True']
