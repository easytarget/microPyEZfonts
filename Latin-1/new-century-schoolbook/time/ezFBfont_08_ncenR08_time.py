...
_g = {
  ...
  43:b'\x00\x00\x00  \xf8  \x06',
  45:b'\x00\x00\x00\x00\x00\xe0\x00\x00\x04',
  46:b'\x00\x00\x00\x00\x00\x00@@\x04',
  48:b'`\x90\x90\x90\x90\x90\x90`\x05',
  49:b' `     p\x05',
  50:b'`\x90\x90\x10 @\x90\xf0\x05',
  51:b'`\x90\x10`\x10\x90\x90`\x05',
  52:b'\x100PP\x90\xf8\x108\x05',
  53:b'\xf0\x80\x80\xe0\x10\x10\x90`\x05',
  54:b'p\x90\x80\xe0\x90\x90\x90`\x05',
  55:b'\xf0\x90   @@@\x05',
  56:b'`\x90\x90`\x90\x90\x90`\x05',
  57:b'`\x90\x90\x90p\x10\x90\xe0\x05',
  58:b'\x00\x00\x00@@\x00@@\x04',
}
