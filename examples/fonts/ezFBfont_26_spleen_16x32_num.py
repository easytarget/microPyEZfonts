'''
    ezFBfont_26_spleen_16x32_num : generated as part of the microPyEZfonts repository
...
# Font: spleen-16x32
# Cmd: [bdf2dict.py], ['Latin-1-bdf-sources/spleen-16x32.bdf', './num-char.set', 'True']
...
def get_ch(ch):
    ...
    if c not in _g.keys():
        return None, 0, 0
    return memoryview(_g[c][0]), 26, 16
