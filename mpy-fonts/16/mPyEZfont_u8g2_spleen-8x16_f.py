'''
    mPyEZfont_u8g2_spleen-8x16_f.py : generated as part of the microPyEZfonts repository
...
# Font: spleen-8x16.bdf Char set:  !"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\]^_`abcdefghijklmnopqrstuvwxyz{|}~¡¢£¤¥¦§¨©ª«¬®¯°±²³´µ¶·¸¹º»¼½¾¿ÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏÐÑÒÓÔÕÖ×ØÙÚÛÜÝÞßàáâãäåæçèéêëìíîïðñòóôõö÷øùúûüýþÿ
# Cmd: micropython-font-to-py/font_to_py.py -x -k mpy-fonts/f-char.set u8g2/tools/font/bdf/spleen-8x16.bdf 0 tmp_mPyEZfont_u8g2_spleen-8x16_f.py
version = '0.33'
...
b'\xc0\x00\x00\x00\x00\x00\x00\x00\x08\x00\x00\x00\x6c\x6c\x00\xc6'\
b'\xc6\xc6\xc6\xc6\xc6\x7e\x06\x06\xfc\x00'
