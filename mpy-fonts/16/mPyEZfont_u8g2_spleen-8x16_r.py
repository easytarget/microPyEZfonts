'''
    mPyEZfont_u8g2_spleen-8x16_r.py : generated as part of the microPyEZfonts repository
...
# Font: spleen-8x16.bdf Char set:  !"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\]^_`abcdefghijklmnopqrstuvwxyz{|}~
# Cmd: micropython-font-to-py/font_to_py.py -x -k mpy-fonts/r-char.set u8g2/tools/font/bdf/spleen-8x16.bdf 0 tmp_mPyEZfont_u8g2_spleen-8x16_r.py
version = '0.33'
