'''
    mPyEZfont_u8g2_spleen-6x12_r.py : generated as part of the microPyEZfonts repository
...
# Font: spleen-6x12.bdf Char set:  !"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\]^_`abcdefghijklmnopqrstuvwxyz{|}~
# Cmd: micropython-font-to-py/font_to_py.py -x -k mpy-fonts/r-char.set u8g2/tools/font/bdf/spleen-6x12.bdf 0 tmp_mPyEZfont_u8g2_spleen-6x12_r.py
version = '0.33'
