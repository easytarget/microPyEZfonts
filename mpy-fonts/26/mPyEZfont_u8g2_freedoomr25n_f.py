'''
    mPyEZfont_u8g2_freedoomr25n_f.py : generated as part of the microPyEZfonts repository
...
# Font: freedoomr25n.bdf Char set:  !"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\]^_`abcdefghijklmnopqrstuvwxyz{|}~¡¢£¤¥¦§¨©ª«¬®¯°±²³´µ¶·¸¹º»¼½¾¿ÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏÐÑÒÓÔÕÖ×ØÙÚÛÜÝÞßàáâãäåæçèéêëìíîïðñòóôõö÷øùúûüýþÿ
# Cmd: micropython-font-to-py/font_to_py.py -x -k mpy-fonts/f-char.set u8g2/tools/font/bdf/freedoomr25n.bdf 0 tmp_mPyEZfont_u8g2_freedoomr25n_f.py
version = '0.33'
...
b'\x00\x00\x00\x00\x00\x00\x07\xc0\x07\xc0\x07\xc0\x07\xc0\x07\xc0'\
b'\x00\x00\x00\x00\x00\x00\x07\xc0\x07\xc0\x07\xc0\x07\xc0\x07\xc0'\
b'\x1e\x00\x1e\x00\x1e\x00\x00\x00\x00\x00'
...
b'\x8e\x03\xde\x03\x2e\x04\x7e\x04\xb4\x04\xea\x04'
...
def get_ch(ch):
    oc = ord(ch)
    ioff = 2 * (oc - 32 + 1) if oc >= 32 and oc <= 59 else 0
    doff = ifb(_mvi[ioff : ])
