...
# Font: helvR08.bdf Char set:  !"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\]^_`abcdefghijklmnopqrstuvwxyz{|}~
# Cmd: ../micropython-font-to-py/font_to_py.py -x -k ./r-char.set -e 32 ../u8g2/tools/font/bdf/helvR08.bdf 0 tmp_mPyEZfont_u8g2_helvR08_r.py
version = '0.33'
