...
# Font: helvB08_gps.bdf Char set:  !"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\]^_`abcdefghijklmnopqrstuvwxyz{|}~¡¢£¤¥¦§¨©ª«¬®¯°±²³´µ¶·¸¹º»¼½¾¿ÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏÐÑÒÓÔÕÖ×ØÙÚÛÜÝÞßàáâãäåæçèéêëìíîïðñòóôõö÷øùúûüýþ
# Cmd: ../micropython-font-to-py/font_to_py.py -x -k ./e-char.set -e 32 ../u8g2/tools/font/bdf/helvB08_gps.bdf 0 tmp_mPyEZfont_u8g2_helvB08_gps_e.py
version = '0.33'
